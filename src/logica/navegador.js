...
// ─── CUSTOS DE TERRENO (Legenda Oficial Numérica) ───────────────────────────
const CUSTO_TERRENO = {
  14: 200, // Montanhoso (+200 min)
  15: 1,   // Plano (+1 min)
  16: 5,   // Rochoso (+5 min)
  0: 1,    // Partida (tratado como plano para pisar)
  13: 1    // Chegada / Grande Mestre (tratado como plano)
};
...
function obterCustoMovimento(celula) {
  ...
  // Se for uma casa do zodíaco (1 a 12), o custo de caminhar por ela é 1
...
var SIMBOLOS_TERRENO = { 14: '#', 16: '.', 15: ' ', 0: 'S', 13: 'G' };
